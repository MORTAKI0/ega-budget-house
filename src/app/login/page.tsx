    ...
    <main className="relative isolate flex min-h-dvh items-center justify-center overflow-hidden bg-[#f7fbf5] px-4 py-8 text-slate-900 sm:px-6 lg:px-8">
      ...
      <section className="relative z-10 flex w-full max-w-6xl min-w-0 items-center justify-center">
        ...
        <Card
          ...
          style={{ maxWidth: "min(calc(100vw - 2rem), 34rem)" }}
        >
          <CardContent className="px-0">
            ...
            <div className="text-center">
              ...
              <p className="mx-auto mt-3 max-w-sm text-base leading-7 text-slate-600">
                Log in to continue tracking your monthly budget.
              </p>
            </div>
    ...
    >
      <CardContent className="p-5">
        ...
        <div className="mt-4 flex items-center gap-4">
          <div className="size-16 rounded-full bg-[conic-gradient(#16a34a_0deg_250deg,#d9f2df_250deg_360deg)] p-3">
...
function SafeBalanceCard() {
  return (
    ...
    >
      <CardContent className="p-5">
        <p className="text-xs font-semibold text-slate-500">Safe Balance</p>
        <p className="mt-4 text-2xl font-black text-slate-700">$900</p>
        <div className="mt-3 h-2 overflow-hidden rounded-full bg-emerald-100">
          <div className="h-full w-[68%] rounded-full bg-emerald-500" />
        </div>
        <p className="mt-4 text-sm font-bold text-emerald-700">Protected</p>
      </CardContent>
    </Card>
  );
}
